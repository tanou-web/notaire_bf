    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_token', models.CharField(choices=[('email', 'Email'), ('telephone', 'Téléphone'), ('password_reset', 'Réinitialisation mot de passe')], max_length=30, verbose_name='Type de token')),
